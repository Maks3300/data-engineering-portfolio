...
Portfolio website for Mayank Maheshwari, focused on data engineering, analytics engineering, SQL, Python automation, cloud warehouses, and reporting workflows.
...
- `styles.css` - responsive layout, visual design, and reduced-motion support
- `script.js` - dynamic footer year
- `PORTFOLIO_NOTES.md` - maintenance notes and recommended update workflow

## Portfolio Links

- GitHub: https://github.com/Maks3300
- LinkedIn: https://www.linkedin.com/in/mayank-maheshwari-42035422/
- Email: mayankuit33@gmail.com
...
This site publishes from the `main` branch root using GitHub Pages.
